...
$db_handle = new DBController();
	...
	if($token!=''){
  		$sql_query_token = sqlQUERY_LABEL("SELECT `offers_id`,`prdt_id` FROM `js_offers_items` where offers_id = '$token' and deleted = '0' and status = '2'") or die("#STATUS-SELECT: Getting Status: ".sqlERROR_LABEL());
		...
		//	$offers_id = $set_sql_query_token['offers_id'];
			...
			$category_token =  getSINGLEDBVALUE('productcategory', " productID='$productID_token' and deleted = '0' and status = '1'", 'js_product', 'label');
