            ...
            <div class="page-content">
            	<div class="cart">
	                <div class="container">
	                	...
	                	<div class="row">
	                		<div class="col-lg-9">
	                			<table class="table table-cart table-mobile" id="qty_total_update">
									<thead>
										<tr>
											<th>Product</th>
											<th>Price</th>
											...
											<td class="product-col">
												<div class="product">
													...
													<h3 class="product-title">
														<a href="product.php?token=<?php echo $product_ID.'-'.convertSEOURL($product_title).'-'.$productsku; ?>" title="<?php echo $product_title; ?>"><?php echo html_entity_decode($product_title); ?></a><br><?php if($product_variant_id !='0'){ ?><small><?php echo 'Size: '.getVARIANT_CODE($product_variant_id,'variant_name_from_variant_ID'); ?></small><?php } ?>
													</h3><!-- End .product-title -->
												</div><!-- End .product -->
											</td>
											<td class="price-col" id="product-price"><span class="product-price text-dark" style="padding-top:15px;"><?php echo general_currency_symbol; ?> <?php if($product_variant_id == '0'){echo number_format($product_price,2);}else{echo number_format($variant_product_price+$tot_taxt_amt_for_od_qty,2);} ?></span></td>
