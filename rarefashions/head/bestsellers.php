        ...
        <div class="d-sm-flex align-items-center justify-content-between">
          ...
          <div class="mg-t-20 mg-sm-t-0">
            ...
            <?php } if(in_array($route,array('preview'))){ ?>
				<a href="<?php echo BASEPATH; ?>bestsellers"  class="btn btn-xs btn-secondary btn-icon mg-r-2">Back</a>
	...
	$('#since_to').datepicker({
      ...
      $(function(){
        ...
        $('#customersalesreportLIST').DataTable({
          //responsive: true,
		  	dom: 'Bfrtip',
          'ajax': 'engine/json/JSONbestsellers.php?filter_customer=<?php echo $filter_customer; ?>&since_from=<?php echo $since_from; ?>&since_to=<?php echo $since_to; ?>',
           "columns": [
            { "data": "count" },
			{ "data": "product_name" },
			{ "data": "order_quantity" },
