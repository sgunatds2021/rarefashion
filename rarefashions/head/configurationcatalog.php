...
<html lang="en">
  ...
  <?php
    if($code == '1') { 
      $displayMSG_globalclass->displayMSG($code, "Success", 'Catalogue Settings created Successfully', 'success');
    }
  if($code == '2') { 
      $displayMSG_globalclass->displayMSG($code, "Success", 'Catalogue Updated created Successfully', 'success');
    }
    if($code == '0') {
      $displayMSG_globalclass->displayMSG($code, "Error", 'Unable to Update Catalogue Settings.', 'error');  
    }
