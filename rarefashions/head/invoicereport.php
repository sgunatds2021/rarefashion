  ...
  <body style="overflow-x:hidden">
        ...
        <div class="d-sm-flex align-items-center justify-content-between">
          ...
          <div class="mg-t-20 mg-sm-t-0">
            ...
            <?php } if(in_array($route,array('preview'))){ ?>
             <a href="<?php echo BASEPATH; ?>invoicereport" class="btn btn-xs btn-success btn-icon mg-r-2"> <?php echo $__back; ?></a>
            <?php } ?>
	...
	<?php if($route == '') {  ?>
        ...
        $('#invoiceLIST').DataTable({
          responsive: true,
		  dom: 'Bfrtip',
          'ajax': 'engine/json/JSONinvoice.php?filter_customer=<?php echo $filter_customer; ?>&since_from=<?php echo $since_from; ?>&since_to=<?php echo $since_to; ?>',
           "columns": [
            { "data": "count" },
			{ "data": "order" },			
			{ "data": "date" },
		  ...
		  
		  {
				...
				"render": function ( data, type, row, full, meta ) {
					return '<a title="Click to Preview" href="order.php?route=preview&formtype=preview&id='+row.modify+'">'+row.order+'</a>';
					//return '';
				}
			},
