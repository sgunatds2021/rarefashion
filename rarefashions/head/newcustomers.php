  ...
  <body style="overflow-x:hidden">
        ...
        <div class="d-sm-flex align-items-center justify-content-between">
          ...
          <div class="mg-t-20 mg-sm-t-0">
            ...
            <?php } if(in_array($route,array('preview'))){ ?>
             <a href="<?php echo BASEPATH; ?>newcustomers" class="btn btn-xs btn-success btn-icon mg-r-2"> <?php echo $__back; ?></a>
            <?php } ?>
	...
	<?php if($route == '') {  ?>
        ...
        $('#newcustomerLIST').DataTable({
          responsive: true,
		  dom: 'Bfrtip',
          'ajax': 'engine/json/JSONnewcustomers.php?filter_customer=<?php echo $filter_customer; ?>&since_from=<?php echo $since_from; ?>&since_to=<?php echo $since_to; ?>',
           "columns": [
            { "data": "count" },
			{ "data": "customer_name" },
			{ "data": "customeremail" },
