  ...
  <body style="overflow-x:hidden">
	...
	<?php if($route == '') {  ?>
        ...
        $('#invoiceLIST').DataTable({
          responsive: true,
		  dom: 'Bfrtip',
          'ajax': 'engine/json/JSONorderedreport.php?status=6&filter_customer=<?php echo $filter_customer; ?>&since_from=<?php echo $since_from; ?>&since_to=<?php echo $since_to; ?>',
           "columns": [
            { "data": "count" },
			{ "data": "order" },			
			{ "data": "date" },
		  ...
		  
		  {
				...
				"render": function ( data, type, row, full, meta ) {
					return '<a title="Click to Preview" href="order?route=preview&formtype=preview&id='+row.modify+'">'+row.order+'</a>';
					//return '';
				}
			},
