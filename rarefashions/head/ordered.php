        ...
        <div class="d-sm-flex align-items-center justify-content-between">
          ...
          <div class="mg-t-20 mg-sm-t-0">
            ...
            <?php } if(in_array($route,array('preview'))){ ?>
				<a href="<?php echo BASEPATH; ?>ordered"  class="btn btn-xs btn-secondary btn-icon mg-r-2">Back</a>
	...
	$('#since_to').datepicker({
      ...
      $(function(){
        ...
        $('#customersalesreportLIST').DataTable({
          //responsive: true,
		  	dom: 'Bfrtip',
          'ajax': 'engine/json/JSONordered.php?filter_customer=<?php echo $filter_customer; ?>&since_from=<?php echo $since_from; ?>&since_to=<?php echo $since_to; ?>',
           "columns": [
            { "data": "count" },
			{ "data": "od_refno" },
			{ "data": "product_name" },
		  ...
		  
		  {
				...
				"render": function ( data, type, row, full, meta ) {
					return '<a title="Click to Preview" href="order.php?route=preview&formtype=preview&id='+row.modify+'">'+row.od_refno+'</a>';
					//return '';
				}
			},
			{
