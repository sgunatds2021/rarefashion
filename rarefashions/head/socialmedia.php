...
<html lang="en">
  ...
  <?php
    if($code == '1') { 
      $displayMSG_globalclass->displayMSG($code, "Success", 'Socialmedia created Successfully', 'success');
    }
	  if($code == '2') { 
		  $displayMSG_globalclass->displayMSG($code, "Success", 'Socialmedia Updated Successfully', 'success');
		}
    if($code == '0') {
