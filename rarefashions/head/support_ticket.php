  ...
  <body>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content tx-14">
          <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel2">Complaint Discription</h6>
    ...
    <script>
      $(function(){
        ...
        $('#LIST').DataTable({
          //responsive: true,
          'ajax': 'engine/json/JSONsupport_ticket.php',
           "columns": [
            { "data": "count" },
            { "data": "product" },
            { "data": "customer" },
          ...
          return '<a title="Click to Preview" onclick="view_complaint('+data+')" class="btn btn-light btn-icon"><i class="fa fa-eye"></i></a> <a title="Click to Preview" href="support_ticket.php?route=preview&id='+data+'" class="btn btn-light btn-icon"><i class="fa fa-pen"></i></a>';
          //return '';
        }
...
<?php } ?>
	...
	function  view_complaint(id) { 
		...
		$('.receiving-view-data').load('view/r__support_ticket.php?route=view&id='+SELECTED_ID+'',function(){
	...
	$.ajax({
		url: url,
		type: "GET",
		data:  {rowcount:$("#rowcount").val(),"pagination_setting":"all-links",id:id},
...
$( document ).ready(function() {
	getresult("engine/ajax/email_pagination.php");
});
