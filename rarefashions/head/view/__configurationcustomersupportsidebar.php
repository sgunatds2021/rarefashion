<?php 
if($__configurationcustomersupport_sidebar_view_type=='' || $__configurationcustomersupport_sidebar_view_type=='list') {
?>
...
//For Create Page
if($__configurationcustomersupport_sidebar_view_type=='create') {
?>
  <div class="col-lg-3 mg-t-40 mg-lg-t-0 d-sm-none d-md-block">
