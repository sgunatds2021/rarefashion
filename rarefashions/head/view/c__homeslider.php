		...
		if($media_size<(2000*2000))
			{
				...
				if(move_uploaded_file($tmp, $media_path.$homeslider_image)) {
					...
					if(sqlACTIONS("INSERT","js_homeslider",$arrFields,$arrValues,'')) {
						
						echo "<div style='width: 350px; text-align: center; margin: 10% auto 0px; font-family: arial; font-size: 14px; border: 1px solid #ddd; padding: 20px 40px;'>Please wait while we update...</div>";

						if( $save == "save"	) {
							?>
							<script type="text/javascript">window.location = '<?php echo $currentpage; ?>?route=add&code=1' </script>
							<?php
						} else {
							?>
							<script type="text/javascript">window.location = '<?php echo $currentpage; ?>?code=1' </script>
							<?php
						}
            ...
            <div class="mg-b-25">
				...
				<div id="basic">
				  ...
				  <div class="form-group row">
					...
					<div class="col-sm-7">
						<div class="custom-control custom-switch">
						  <input type="checkbox" class="custom-control-input" name="homesliderstatus" id="homesliderstatus" checked="">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-7">
						...
						<div class="custom-file">
						  ...
						  <label class="custom-file-label" for="customFile"><?php echo $__homeslidergchoosefile ?></label>
						</div>
				  ...
				  <div class="form-group row">
					...
					<div class="col-sm-7">
						  <input type="text" class="form-control" placeholder="First Title" name="homeslidertitle1" id="homeslidertitle1" >
					</div>
				  </div>
				  ...
				  <div class="form-group row">
					...
					<div class="col-sm-7">
						  <input type="text" class="form-control" placeholder="Second Bold Title" name="homeslidertitle2" id="homeslidertitle2" >
					</div>
				  </div>
				  ...
				  <div class="form-group row">
					...
					<div class="col-sm-7">
						  <textarea class="form-control" rows="2"  name="homeslidertext" id="homeslidertext"></textarea>
					</div>
				  </div>
				   ...
				   <div class="form-group row">
					...
					<div class="col-sm-7">
						  <input type="text" class="form-control" placeholder="Display Order" name="display_order" id="display_order" required data-parsley-error-message="Please enter Display Order" >
					</div>
				  </div>
				  ...
				  <div class="form-group row">
					...
					<div class="col-sm-7">
						  <input type="text" class="form-control" placeholder="Slider Link" name="homesliderlink" id="homesliderlink" >
					</div>
				  </div>
				  ...
				  <div class="form-group row">
					...
					<div class="col-sm-7">
						  <input type="text" class="form-control" placeholder="Link Text" name="homesliderlinktext" id="homesliderlinktext" >
					</div>
				  </div>
