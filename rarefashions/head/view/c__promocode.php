...
if($save == "save" || $save_close == "save_close") {
	...
	if($status == 'on') { $status = '1'; } else { $status = '0'; }
		...
		if(sqlACTIONS("INSERT","js_promocode",$arrFields,$arrValues,'')) {
			
			echo "<div style='width: 350px; text-align: center; margin: 10% auto 0px; font-family: arial; font-size: 14px; border: 1px solid #ddd; padding: 20px 40px;'>Please wait while we update...</div>";

			if( $save == "save"	) {
				?>
				<script type="text/javascript">window.location = 'promocode.php?route=add&code=1' </script>
				<?php
				//header("Location:category.php?route=add&code=1");
			} else {
				?>
				<script type="text/javascript">window.location = 'promocode.php?code=1' </script>
				<?php
            ...
            <div class="mg-b-25">
				...
				<div id="basic">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="promocode_name" id="promocode_name" placeholder="Promocode Name" required>
                    </div>
                  </div>
				  <div class="form-group row">
                    <label for="promocode_code" class="col-sm-3 col-form-label">Promocode Code <span class="tx-danger">*</span></label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="promocode_code" id="promocode_code" placeholder="Promocode Code" required>
                    </div>
                  </div>
                  
                   <div class="form-group row">
				    <label for="promocode_value" class="col-sm-3 col-form-label">Promocode Value <span class="tx-danger">*</span></label>
				    <div class="col-sm-7">
				    	<input type="text" class="form-control" name="promocode_value" id="promocode_value" placeholder="Promocode Value" required>
				    </div>
				  </div>
				  
				  <div class="form-group row">
				    <label for="promocode_type" class="col-sm-3 col-form-label">Promocode Type <span class="tx-danger">*</span></label>
				    <div class="col-sm-7">
				    	<select class="form-control custom-select" id="promocode_type" name="promocode_type" required>
						<option value="">--</option>
				   ...
				   <div class="form-group row">
				    ...
				    <div class="col-sm-7">
				    	<input type="text" class="form-control" name="min_order_amount" id="min_order_amount" placeholder="Minimum Order Amount" required data-parsley-pattern="^[0-9]*$" data-parsley-trigger="keyup">
				    </div>
				  </div>
				   ...
				   <div class="form-group row" id="maximum_dis_amount">
				    ...
				    <div class="col-sm-7">
				    	<input type="text" class="form-control" name="max_discount_amt" id="max_discount_amt" placeholder="Maximum Discount Amount" data-parsley-pattern="^[0-9]*$" data-parsley-trigger="keyup">
				    </div>
				  </div>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-7">
				    	<select class="form-control custom-select" id="promocode_option" name="promocode_option">
						<option value="1" <?php if($promocode_option == '1'){ echo 'selected'; } ?>>Multiple Use</option>
						</select>
				    </div>
				  </div>
				  
				  <div class="form-group row">
				    <label for="promocode_expiry_date" class="col-sm-3 col-form-label">Promocode Expiry Date <span class="tx-danger">*</span></label>
				    <div class="col-sm-7">
				    	<input type="text" class="form-control" name="promocode_expiry_date" id="promocode_expiry_date" placeholder="DD/MM/YYYY" required>
				    </div>
				  </div>
