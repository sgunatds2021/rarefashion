...
if($save == "save" || $save_close == "save_close") {
	...
	if($status == 'on') { $status = '1'; } else { $status = '0'; }
					...
					if(sqlACTIONS("INSERT","js_vendor",$arrFields,$arrValues,'')) {
						...
						if( $save == "save"	) {
							?>
							<script type="text/javascript">window.location = 'vendors.php?route=add&code=1' </script>
							<?php
            ...
            <div class="mg-b-25">
				...
				<div id="basic">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-7">
				      <input type="text" class="form-control" name="vendorname" id="vendorname" placeholder="Vendor Name" required data-parsley-pattern="^[a-zA-Z ]+$" data-parsley-trigger="keyup" autocomplete="off">
				    </div>
				  </div>

				  <div class="form-group row">
				    <label for="vendor_nickname" class="col-sm-2 col-form-label">Vendor Nick Name<span class="tx-danger"> *</span></label>
				    <div class="col-sm-7">
				      <input type="text" class="form-control" name="vendor_nickname" id="vendor_nickname" placeholder="Vendor Nick Name" required data-parsley-pattern="^[a-zA-Z ]+$" data-parsley-trigger="keyup" autocomplete="off">
				    </div>
				  </div>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-7">
						...
						<input type="text" class="form-control" name="vendor_code" id="vendor_code" required value="<?php if($id ==""){ echo getnewVENDOR('vendor',$vendor_code); } else{ echo $vendor_code;} ?>" required data-parsley-trigger="keyup" data-parsley-pattern="^[a-zA-Z0-9 ,-/]*$" data-parsley-whitespace="trim" data-parsley-checkcode data-parsley-checkcode-message="Vendor code already Exists">
					</div>
				  </div>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-7">
				    	 <input type="text" class="form-control" name="contactperson" id="contactperson"  placeholder="Contact Person" data-parsley-trigger="keyup" autocomplete="off">
				    </div>
				  </div>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-7">
				    	 <input type="text" class="form-control" name="contactnumber" id="contactnumber"  placeholder="Contact Number" data-parsley-type="number" data-parsley-trigger="keyup" maxlength="10" autocomplete="off">
				    </div>
				  </div>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-7">
				    	 <input type="text" class="form-control" name="contactemail" id="contactemail"  placeholder="Contact Email" data-parsley-type="email" data-parsley-trigger="keyup" autocomplete="off">
				    </div>
				  </div>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-7">
				    	 <input type="text" class="form-control text-uppercase" name="gstin" id="gstin"  placeholder="GSTIN" maxlength="15" data-parsley-type="alphanum" data-parsley-trigger="keyup" autocomplete="off">
				    </div>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-7">
				    	 <input type="text" class="form-control text-uppercase" name="pan" id="pan"  placeholder="PAN No" data-parsley-trigger="keyup" data-parsley-pattern="[A-Za-z]{5}\d{4}[A-Za-z]{1}" maxlength="10" autocomplete="off">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-7">
				    	 <input type="text" class="form-control text-uppercase" name="tan" id="tan" placeholder="TAN No" data-parsley-type="alphanum" data-parsley-trigger="keyup" autocomplete="off">
				    </div>
				  </div>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-7">
				    	 <input type="text" class="form-control text-uppercase" name="msg" id="msg" placeholder="MSG No" data-parsley-type="alphanum" data-parsley-trigger="keyup" autocomplete="off">
				    </div>
				  </div>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-7">
				    	 <input type="text" class="form-control text-uppercase" name="bankname" id="bankname"  placeholder="Bank Name" data-parsley-pattern="^[a-zA-Z ]+$" data-parsley-trigger="keyup" autocomplete="off">
				    </div>
				  </div>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-7">
				    	 <input type="text" class="form-control" name="accountnumber" id="accountnumber"  placeholder="A/C Number" data-parsley-type="number" data-parsley-trigger="keyup" autocomplete="off">
				    </div>
				  </div>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-7">
				    	 <input type="text" class="form-control text-uppercase" name="neftcode" id="neftcode"  placeholder="NEFT Code" data-parsley-trigger="keyup" data-parsley-type="alphanum" autocomplete="off">
				    </div>
				  </div>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-7">
				    	 <textarea type="text" class="form-control" name="payment_terms" id="payment_terms" placeholder="Payment Terms"></textarea>
				    </div>
				  </div>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-7">
				    	 <textarea type="text" class="form-control" name="comments" id="comments" placeholder="Comments"></textarea>
				    </div>
				  </div>
