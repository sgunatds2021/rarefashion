...
?>
  <div class="content">
	  ...
	  <form>
				...
				<div class="card-body">
					...
					<div class="mg-md-t-20 text-left col-md-3">
						...
						<a href="invoicereport" class="btn btn-light">Clear</a>
					</div>					
					</div>
				</div>
				</div>
	  ...
	  <div class="row">
		<div class="col-md-4">
		<?php
		$list_datas = sqlQUERY_LABEL("SELECT * FROM `js_shop_order` WHERE od_payment_status = '1' and deleted = '0' {$filterby_date} ORDER BY od_id DESC") or die("Unable to get records:".sqlERROR_LABEL());
		...
		$ord_qty = $od_qty = getORDERQTY($id, $od_userid);
		...
		<div class="media mg-t-20 mg-sm-t-0">
			...
			<div class="media-body">
				<h6 class="tx-sans tx-uppercase tx-spacing-1 tx-color-03 tx-semibold mg-b-5 mg-md-b-8">Total Invoice</h6>
			  ...
			  <table id="invoiceLIST" class="table table-bordered" width="99%">
			    <thead>
			        <tr>
			            ...
			            <th class="wd-10p">Total Amount (<?php echo general_currency_symbol; ?>)</th>
