...
?>
    <div class="content">
	  ...
	  <form>
				...
				<div class="card-body">
					...
					<div class="mg-md-t-20 text-left col-md-3">
						...
						<a href="<?php echo BASEPATH; ?>orderdeliveredreport" class="btn btn-light">Clear</a>
					</div>					
					</div>
				</div>
				</div>
	  ...
	  <div class="row mg-md-b-20">
		<div class="col-md-4">
		<?php
		$list_datas = sqlQUERY_LABEL("SELECT * FROM `js_shop_order` WHERE od_status = '6' and deleted = '0' {$filterby_date}  ORDER BY od_id DESC") or die("Unable to get records:".sqlERROR_LABEL());
		...
		<div class="media mg-t-20 mg-sm-t-0">
			...
			<div class="media-body">
				<h6 class="tx-sans tx-uppercase tx-spacing-1 tx-color-03 tx-semibold mg-b-5 mg-md-b-8">Total Delevered Order</h6>
