...
?>
    <div class="content">
	  ...
	  <form>
				...
				<div class="card-body">
					...
					<div class="mg-md-t-20 text-left col-md-3">
						...
						<a href="<?php echo BASEPATH; ?>orderrefund" class="btn btn-light">Clear</a>
					</div>					
					</div>
				</div>
				</div>
	  ...
	  <div class="row">
		<div class="col-md-4">
		<?php
		$list_datas = sqlQUERY_LABEL("SELECT * FROM `js_shop_order` WHERE od_status = '8' and deleted = '0' ORDER BY od_id DESC") or die("Unable to get records:".sqlERROR_LABEL());
