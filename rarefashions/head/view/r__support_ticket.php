...
//$mailcontent=html_entity_decode($mail_content);
				...
				$from = "Carsjockey - Complaint Response <notification@itservicesingapore.com>";
			  ...
			  <table id="LIST" class="table table-bordered" width="99%">
			    <thead>
			        <tr>
						...
						<th class="wd-10p">Booking Id</th>
			            <th class="wd-10p">Customer Name</th>
			            <th class="wd-15p">Status</th>
			            <th class="wd-15p">Complaint</th>
			        </tr>
			    </thead>
			</table>
			</div>
		...
		if($status==1){
			...
			<div id="stickThis" class="form-group row mg-b-0" style="width: 1185px;">
				...
				<div class="col-9 col-sm-6 text-right">
					...
					<a href="support_ticket.php" class="btn btn-warning"><?php echo $__back; ?></a>
				</div>
			</div>
			...
			<div class="card">
				...
				<span class="mr-auto text-primary">ST0001</span>
