...
if($type == 'delete') {
	...
	$get_homeiconID = sqlQUERY_LABEL("select * from js_subscriber where subscriber_ID = '$delete_id'") or die(mysqli_error());
	...
	if($count_rows != '0' ) { 
			...
			echo "<hr><a href='subscriber.php?action=delete&id=".$delete_id."' class='btn btn-success btn-sm'>Delete</a>";
...
if($type == 'changestatus') {
	...
	return sqlACTIONS("UPDATE","js_subscriber",$arrFields,$arrValues, $sqlWhere);
}