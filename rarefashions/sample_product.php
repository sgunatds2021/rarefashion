...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="favicons/icons-apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="favicons/icons-favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="favicons/icons-favicon-16x16.png">
    ...
    <link rel="stylesheet" href="css/nouislider-nouislider.css">
</head>
...
<body>
    <div class="page-wrapper">
                ...
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="index.html" class="logo">
                            <img src="images/images-logo.png" alt="Molla Logo" width="105" height="25">
                        </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-cart-products">
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="images/cart-product-1.jpg" alt="product">
                                            </a>
                                        </figure>
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                    </div><!-- End .product -->
                                    ...
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="images/cart-product-2.jpg" alt="product">
                                            </a>
                                        </figure>
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                    </div><!-- End .product -->
                            ...
                            <div class="col-md-6">
                                <div class="product-gallery product-gallery-separated">
                                    ...
                                    <figure class="product-separated-item">
                                        <img src="images/sticky-1.jpg" data-zoom-image="assets/images/products/single/sticky/1-big.jpg" alt="product image">
                                    ...
                                    <figure class="product-separated-item">
                                        <img src="images/sticky-2.jpg" data-zoom-image="assets/images/products/single/sticky/2-big.jpg" alt="product image">
                                    </figure>

                                    <figure class="product-separated-item">
                                        <img src="images/sticky-3.jpg" data-zoom-image="assets/images/products/single/sticky/3-big.jpg" alt="product image">
                                    </figure>

                                    <figure class="product-separated-item">
                                        <img src="images/sticky-4.jpg" data-zoom-image="assets/images/products/single/sticky/4-big.jpg" alt="product image">
                                    </figure>
                        ...
                        <div class="product product-7">
                            <figure class="product-media">
                                ...
                                <div class="product-action-vertical">
                                    ...
                                    <a href="quickView.html" class="btn-product-icon btn-quickview" title="Quick view"><span>Quick view</span></a>
        ...
        <footer class="footer">
	            	...
	            	<div class="row">
	            		<div class="col-sm-6 col-lg-3">
	            			<div class="widget widget-about">
	            				<img src="images/images-logo.png" class="footer-logo" alt="Footer Logo" width="105" height="25">
	        ...
	        <div class="footer-bottom">
	        	<div class="container">
	        		<p class="footer-copyright">Copyright &copy; 2019 Molla Store. All Rights Reserved.</p><!-- End .footer-copyright -->
	        		<figure class="footer-payments">
	        			<img src="images/images-payments.png" alt="Payment methods" width="272" height="20">
    ...
    <script src="js/js-jquery.hoverIntent.min.js"></script>
    <script src="js/js-jquery.waypoints.min.js"></script>
    <script src="js/js-superfish.min.js"></script>
    <script src="js/js-owl.carousel.min.js"></script>
    <script src="js/js-bootstrap-input-spinner.js"></script>
    <script src="js/js-jquery.plugin.min.js"></script>
    <script src="js/js-jquery.countdown.min.js"></script>
    <script src="js/js-jquery.elevateZoom.min.js"></script>
    <script src="js/js-bootstrap-input-spinner.js"></script>
