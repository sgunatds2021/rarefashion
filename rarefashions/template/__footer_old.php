        <footer class="footer footer-2">
            <div class="footer-middle">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-4 col-lg-3">
                            <div class="widget">
                                ...
                                <ul class="widget-list">
                                    <li><a href="#">How to shop on RARE</a></li>
                                    <li><a href="">FAQ</a></li>
                        ...
                        <div class="col-sm-4 col-lg-3">
                            <div class="widget">
                                <h4 class="widget-title">About RARE</h4><!-- End .widget-title -->

                                <ul class="widget-list">
                                    <li><a href="about.html">About Us</a></li>
                                    <li><a href="#">Careers at RARE</a></li>
                            ...
                            <div class="widget">
                                ...
                                <div class="col-lg-12">
                                    <div class="icon-box icon-box-left">
                                        ...
                                        <div class="icon-box-content">
                                            <h3 class="icon-box-title">100% ORIGINAL</h3><!-- End .icon-box-title -->
                                            <p>guarantee for all products at rare.com</p>
                                ...
                                <div class="col-lg-12">
                                    <div class="icon-box icon-box-left">
                                        ...
                                        <div class="icon-box-content">
                                            <h3 class="icon-box-title">Return</h3><!-- End .icon-box-title -->
                                            <p>within 30days of receiving your order</p>
                                        </div><!-- End .icon-box-content -->
                                    </div><!-- End .icon-box -->
                                </div>                                
                                <div class="col-lg-12">
                                    <div class="icon-box icon-box-left">
                                        ...
                                        <div class="icon-box-content">
                                            <h3 class="icon-box-title">Get free delivery</h3><!-- End .icon-box-title -->
                                            <p>for every order above Rs. 1199</p>
                                        </div><!-- End .icon-box-content -->
                                    </div><!-- End .icon-box -->
                                </div>
                            </div><!-- End .widget -->
            ...
            <div class="footer-bottom">
                <div class="container">
                    <p class="footer-copyright">Copyright © 2020 RARE Fashions. All Rights Reserved.</p>
