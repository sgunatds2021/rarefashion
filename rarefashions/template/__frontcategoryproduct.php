<!-- special product -->
<?php
$setting_front_page = sqlQUERY_LABEL("SELECT * FROM `js_settingfrontpage`") or die("Unable to get records:".mysql_error());			
...
while($setting_front = sqlFETCHARRAY_LABEL($setting_front_page)){
	...
	$frontpage_categoryshow = $setting_front["_settings_frontpage_categoryshow"];
	$frontpage_categoryID = $setting_front["_settings_frontpage_categoryID"];
	$frontpage_categoryitemcount = $setting_front["_settings_frontpage_categoryitemcount"];
	$frontpage_categorysortby = $setting_front["_settings_frontpage_categorysortby"];
}
/*<span class="onnew"><span class="text">New</span></span></div>*/
if($frontpage_categoryshow == '1') {
?>
<div class="pt-6 pb-6 featured">
                <div class="container-fluid">
                    <div class="heading heading-center mb-3">
                        <h2 class="title">HOT PICKS</h2><!-- End .title -->
					...
					$list_product_datas = sqlQUERY_LABEL("SELECT `productID`, `productsku`, `producttitle`, `productsellingprice`, `productMRPprice`, `productstockstatus`, `productavailablestock` FROM `js_product` where  FIND_IN_SET('$frontpage_categoryID', productcategory) and deleted = '0' and status = '1'") or die("#1-Unable to get records:".mysqli_error());
...
<?php } ?>
<!-- Featured Category Product Area End -->
