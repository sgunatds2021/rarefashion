...
************************************/
//echo "select * FROM `js_shop_order` where `od_userid`='$logged_user_id' and `od_id`='$__main_orderID";
		...
		<tbody>
			<tr>
				<td class="esd-email-paddings" valign="top">
					...
					<table class="es-header" cellspacing="0" cellpadding="0" align="center" style="padding:10px;">
						<tbody>
							<tr>
																...
																<td class="esd-container-frame" width="280" align="left">
																	<table style="background-color: #fef9ef; border-collapse: separate; border-width: 1px; border-style: solid; border-color: #efefef; padding:10px;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#fef9ef">
																		<tbody>
																			...
																			<tr>
																				<td class="esd-block-text es-p20b es-p20r es-p20l" align="left">
																					<p>'.$_checkout_shipping_fname.' '.$_checkout_shipping_lname.'</p>
																					<p>'.$_checkout_shipping_street1.', '.$_checkout_shipping_street2.'</p>
																					<p>'.$_checkout_shipping_city.', '.$_checkout_shipping_state.'</p>
																					<p>'.$_checkout_shipping_country.', '.$_checkout_shipping_pin.' </p>
																					<p>Email : '.$_checkout_shipping_email.'</p>
																					<p>Mobile: '.$_checkout_shipping_phone.'</p>
																				</td>
																			</tr>
																		</tbody>
																	</table>
									...
									<table class="es-content-body" width="600" cellspacing="0" cellpadding="0"  bgcolor="#ccc" align="center">
										<tbody>
											...
											<tr>
											 ...
											 // echo "SELECT SHOP_ITEM.`cart_id`, SHOP_ITEM.`od_id`, SHOP_ITEM.`pd_id`, SHOP_ITEM.`variant_id`, SHOP_ITEM.`od_qty`, SHOP_ITEM.`od_price`, SHOP_ITEM.`item_tax_type`, SHOP_ITEM.`item_tax`, SHOP_ITEM.`item_tax1`, SHOP_ITEM.`item_tax2`, PRDT.`producttitle`, PRDT.`productsku` FROM `js_shop_order_item` AS SHOP_ITEM, `js_product` AS PRDT where SHOP_ITEM.`pd_id` = PRDT.`productID` and SHOP_ITEM.`od_id` = '$__main_orderID' and SHOP_ITEM.deleted = '0' and SHOP_ITEM.status = '0';
										$featured_product_data = sqlQUERY_LABEL("SELECT SHOP_ITEM.`cart_id`, SHOP_ITEM.`od_id`, SHOP_ITEM.`pd_id`,SHOP_ITEM.`redeem_offer_id`, SHOP_ITEM.`offer_id`, SHOP_ITEM.`variant_id`, SHOP_ITEM.`od_qty`, SHOP_ITEM.`od_price`, SHOP_ITEM.`item_tax_type`, SHOP_ITEM.`item_tax`, SHOP_ITEM.`item_tax1`, SHOP_ITEM.`item_tax2`, PRDT.`producttitle`, PRDT.`productsku` FROM `js_shop_order_item` AS SHOP_ITEM, `js_product` AS PRDT where SHOP_ITEM.`pd_id` = PRDT.`productID` and SHOP_ITEM.`od_id` = '$__main_orderID' and SHOP_ITEM.deleted = '0' and SHOP_ITEM.status = '0'") or die("#1-Unable to get records:".mysqli_error());
											...
											while($featured_data = sqlFETCHARRAY_LABEL($featured_product_data)){
												 ...
												 // echo $od_price;
												  ...
												  $offer_id = $featured_data["offer_id"];
												...
												if($redeem_offer_id != '0'){
													...
													$title = '<span style="color : red"><i class="fa fa-gift" aria-hidden="true"></i>'.$offers_name.' Applied </span>';
												  } else{
													$title='';  
												  } 
																			...
																			<tr>
																				<td class="esd-block-text" align="left">
																					...
																					<table style="width: 100%;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0">
																						<tbody>
																							<tr>
																								<td>'.$title.'<br>'.$producttitle.' '.$variant_name.'</td>
																								<td style="text-align: center;" width="60">'.$od_qty.'</td>
																								<td style="text-align: center;" width="100">'. general_currency_symbol.' '.formatCASH($item_total).'
																							    <del><span style="text-align: right; font-size: 16px; line-height: 150%; color: #d48344;"><span style="text-align: right; font-size: 16px; line-height: 150%; color: #d48344;">'.general_currency_symbol.'</span>'.(getMRPprice($pd_id, $variant_id,$od_qty)) .'</span></del></td>
																				...
																				<td class="esd-block-text" align="right">
																					<table style="width: 500px; padding: 20px 10px;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="right">
																						<tbody>
																							...
																							<tr>
																								<td style="text-align: right; font-size: 16px; line-height: 150%;">Offer Discount:</td>
																								<td style="text-align: right; font-size: 16px; line-height: 150%;">'. general_currency_symbol.' '.formatCASH(orderTOTALSUMMARY($__main_orderID, 'offer')).'</td>
																							</tr>
																							<tr>
