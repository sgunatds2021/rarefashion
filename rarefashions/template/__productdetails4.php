<main class="main">
	...
	<div class="page-content">
		...
		<div class="product-details-top">
             <div class="pb-5 mb-4">
			 	<nav aria-label="breadcrumb" class="bg-light breadcrumb-nav border-0 mb-0" style="background-color:#f9f9f9;">
				...
				<?php
					...
					<div class="owl-item active" style="width: 119.333px;">
						<figure class="product-gallery-image">
							<img src="<?php echo $media_path; ?>" data-zoom-image="<?php echo $media_path; ?>" alt="product image">
						</figure>
					</div>
								<?php } } } ?>
					</div></div>
					...
					<div class="col-md-6">
						...
						<?php 
							...
							$check_prdt_variant_datas = sqlQUERY_LABEL("SELECT * FROM `js_productvariants` where deleted = '0' and status = '1' and variantstockstatus='1' and `parentproduct`='$productID'") or die("Unable to get records:".mysqli_error());			
							  ...
							  if($count_productvariant_list > 0) {
							?>
						<div class="details-filter-row details-row-size mb-md-1 mt-2">
							<label>Size:</label>
                            ...
                            <div class="tab-pane fade" id="product-review-tab" role="tabpanel" aria-labelledby="product-review-link">
                                <div class="reviews">
									...
									<div id="product-accordion-review" class="collapse" aria-labelledby="product-review-heading" data-parent="#product-accordion" style="padding: 0px 190px 0px 190px; display:block; ">
											...
											<!--<button type="button" name="Submit_review" id="Submit_review" onclick="add_review();" class="btn button" value="Submit_review" style="background-color:black;color:white;"> Submit</button>-->
			...
			// echo "SELECT productupsell_items FROM `js_product` where productID='$productID' and deleted = '0'";
